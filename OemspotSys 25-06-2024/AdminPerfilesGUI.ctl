    ...
    If Grid.Text <> "" And Grid.Row >= 1 Then
        If MsgBox("Está seguro de borrar [" & Grid.Text & "]?", vbYesNo, "Atención") = vbYes Then
            ...
            If Not AdminPerfilesService.PerfilOrm.eliminarPerfil(CLng(Grid.Text)) Then
                MsgBox "No se puede eliminar Perfil", vbCritical, "Atención"
                Exit Sub
            End If
            UpdateWindow
        End If
...
Private Sub CmdImprimir_Click()
    ...
    exportarGrillaAArchivo Grid, ArchivoTemporal, "Administración de Perfiles", 1
...
Private Sub CmdInternetExplorer_Click()
    ...
    If CommonDialog1.FileName <> "" Then
        exportarGrillaAArchivo Grid, CommonDialog1.FileName, "Administración de Perfiles", 1
    End If
End Sub
