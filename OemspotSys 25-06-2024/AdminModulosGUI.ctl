...
Begin VB.UserControl AdminModulosGUI 
   ClientHeight    =   8670
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12225
   ...
   Begin VB.Image CmdPlanilla 
      Height          =   270
      Left            =   11520
      Picture         =   "AdminModulosGUI.ctx":0000
   ...
   Begin VB.Image CmdInternetExplorer 
      Height          =   270
      Left            =   11160
      Picture         =   "AdminModulosGUI.ctx":0432
   ...
   Begin VB.Image CmdImprimir 
      Height          =   255
      Left            =   10800
      Picture         =   "AdminModulosGUI.ctx":08AC
   ...
   End
End
Attribute VB_Name = "AdminModulosGUI"
 ...
 '*************************************************************
    Static Modo  As Boolean
     If (Grid.MouseRow = 0) Then
        ...
        End If
     End If
    ' Me.Caption = " Ordenando por la columna: " & Grid.MouseCol
End Sub
...
Sub getNumeroPaginas()
    Dim aux As Long
    If GrupoModulosMode = 0 Then
        If AdminModulosService.getCantidadItems(txtBusqueda.Text) Then
        ...
        End If
    Else
        If AdminModulosService.getGrupoModulosCantidadItems(txtBusqueda.Text, GrupoModulosMode) Then
            MaximoNroPagina = AdminModulosService.ModuloQuery.DbRecordsetQRY.Fields(0).value
'            MaximoNroPagina = MaximoNroPagina / MAX_GRID_ROWS_SIZE_SYS
            'afa 07/2009
            'MaximoNroPagina = MaximoNroPagina / MAX_GRID_ROWS_SIZE_SYS
...
Private Sub Combo1_Click()
    ...
    If GrupoModulosMode = 0 Then
        ...
        End If
    Else
        If AdminModulosService.getGrupoModulosList(txtBusqueda.Text, GrupoModulosMode, (NroPagina - 1) * MAX_GRID_ROWS_SIZE_SYS) Then
            fillGrid Grid, AdminModulosService.ModuloQuery.DbRecordsetQRY, 1
        End If
    End If
End Sub
...
Private Sub CmdAgregar_Click()
    If AdminModulosService.tieneLicencias Then
        Set ModuloMOD.ParentWindow = Me
        ModuloMOD.ModuloID = 0
        ModuloMOD.Show vbModal
    Else
        MsgBox "No tiene Licencia para agregar más Módulos al Servidor VIDEOMAN. Por favor, haga click en la opción de menú Principal->Extender Sistema, para solicitar la extensión del Servidor", vbCritical, "Servidor VIDEOMAN"
    End If
End Sub
...
On Error GoTo Salir
    ...
    If Grid.Text <> "" And Grid.Row >= 1 Then
        ...
        Grid.Row = Grid.RowSel
        Set ModuloMOD.ParentWindow = Me
        ModuloMOD.ModuloID = CLng(Grid.Text)
        ModuloMOD.Show vbModal
    End If
    Exit Sub
Salir:
MsgBox "El Formulario ya se encuentra abierto", vbCritical, "Carga de Modulos"
End Sub
...
Private Sub cmdBorrar_Click()
    ...
    If Grid.Text <> "" And Grid.Row >= 1 Then
        If MsgBox("Está seguro de borrar [" & Grid.Text & "]?", vbYesNo, "Atención") = vbYes Then
            Grid.col = 0
            Grid.Row = Grid.RowSel
            If Not AdminModulosService.ModuloOrm.eliminarModulo(CLng(Grid.Text)) Then
                MsgBox "No se puede eliminar Módulo", vbCritical, "Atención"
                Exit Sub
            End If
            UpdateWindow
        End If
...
Private Sub CmdImprimir_Click()
    ...
    exportarGrillaAArchivo Grid, ArchivoTemporal, "Administración de Módulos", 1
...
Private Sub CmdInternetExplorer_Click()
    ...
    If CommonDialog1.FileName <> "" Then
        exportarGrillaAArchivo Grid, CommonDialog1.FileName, "Administración de Módulos", 1
    End If
End Sub
