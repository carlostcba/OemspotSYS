...
Begin VB.UserControl ReporteMovimientosGUI 
   ClientHeight    =   15000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12285
   ...
   Begin VB.Image CmdImprimir 
      Height          =   255
      Left            =   10800
      Picture         =   "ReporteMovimientosGUI.ctx":0000
   ...
   Begin VB.Image CmdInternetExplorer 
      Height          =   270
      Left            =   11160
      Picture         =   "ReporteMovimientosGUI.ctx":043E
   ...
   Begin VB.Image CmdPlanilla 
      Height          =   270
      Left            =   11520
      Picture         =   "ReporteMovimientosGUI.ctx":08B8
      ToolTipText     =   "Exportar Datos a Excel"
      Top             =   120
      Width           =   270
   End
End
Attribute VB_Name = "ReporteMovimientosGUI"
...
'Dim db_accion As String
'Dim accion As String
'Dim db_Historicos As String
