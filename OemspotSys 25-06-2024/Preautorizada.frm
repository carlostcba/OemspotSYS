...
Begin VB.Form PreautorizadasMOD 
   ...
   Begin VB.Image CmdPlanilla 
      Height          =   270
      Left            =   12615
      Picture         =   "Preautorizada.frx":0000
   ...
   Begin VB.Image CmdInternetExplorer 
      Height          =   270
      Left            =   12255
      Picture         =   "Preautorizada.frx":0432
   ...
   Begin VB.Image CmdImprimir 
      Height          =   255
      Left            =   11895
      Picture         =   "Preautorizada.frx":08AC
      ToolTipText     =   "Imprimir Datos"
      Top             =   195
      Width           =   285
   End
End
Attribute VB_Name = "PreautorizadasMOD"
...
Private Sub Form_Load()
    'Set PreautorizadasGUI1.ParentWindow = Me
    'Me.Width = PreautorizadasGUI1.Width + 100
    'Me.Height = PreautorizadasGUI1.Height + 400
    
    Me.TextoBusqueda = ""
    Me.ReadOnly = ReadOnlyMode
    Me.Seleccion = SeleccionMode
'    If db_PreautorizadoID <> "" Then
'      PreautorizadasGUI1.db_PreautorizadoID = db_PreautorizadoID
'    End If
    cmdBuscar_Click
    'PreautorizadasGUI1.init
End Sub

Sub Destroy()
    If Not (ParentWindow Is Nothing) Then
        ParentWindow.PreautorizadoID = db_PreautorizadoID
        ParentWindow.LoteID = db_LoteID
    End If
    Unload Me
End Sub

Sub UpdateWindow(PreautorizadoID As Long)
    If Not (ParentWindow Is Nothing) Then
        ParentWindow.PreautorizadoID = PreautorizadoID
        ParentWindow.LoteID = db_LoteID
        Unload Me
    End If
End Sub
...
If Not Me.ParentWindow Is Nothing Then
    Grid.Col = 0
...
Private Sub Grid_DblClick()
    ...
    Else
        If Grid.Text <> "" And Grid.Row >= 1 Then
            Grid.Col = 0
            Grid.Row = Grid.RowSel
            Me.PreautorizadoID = CLng(Grid.Text)
            Grid.Col = 1
            Grid.Row = Grid.RowSel
            Me.LoteID = CLng(Grid.Text)
            Me.Destroy
        End If
    End If
End Sub
