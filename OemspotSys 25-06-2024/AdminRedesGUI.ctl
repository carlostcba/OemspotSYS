...
Begin VB.UserControl AdminRedesGUI 
   ClientHeight    =   8640
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12135
   ...
   Begin VB.Image CmdPlanilla 
      Height          =   270
      Left            =   11520
      Picture         =   "AdminRedesGUI.ctx":0000
   ...
   Begin VB.Image CmdInternetExplorer 
      Height          =   270
      Left            =   11160
      Picture         =   "AdminRedesGUI.ctx":0432
   ...
   Begin VB.Image CmdImprimir 
      Height          =   255
      Left            =   10800
      Picture         =   "AdminRedesGUI.ctx":08AC
   ...
   End
End
Attribute VB_Name = "AdminRedesGUI"
